...
export class HoldRecorder {
    ...
    abandonActive() {
        ...
        for (const t of this.active.stream.getTracks())
            t.stop(); // 弃轮也要还麦克风
        this.active = null;
    }
    async toWav(raw) {
